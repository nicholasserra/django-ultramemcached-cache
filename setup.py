...
setup(
    ...
    version='0.0.1',
    install_requires=['umemcached'],
    author='Nicholas Serra',
    author_email='nick@528hazelwood.com',
    license='MIT License',
    url='https://github.com/nicholasserra/django-ultramemcached-cache/',
    keywords='python memcache memcached ultramemcached django cache backend',
    description='A django cache backend using ultramemcached',
